...
git submodule add https://github.com/gdsotirov/net-snmp.SlackBuild.git net-snmp
...
git submodule add https://github.com/gdsotirov/hddtemp.SlackBuild.git hddtemp
...
git submodule add https://github.com/gdsotirov/mysql.SlackBuild.git mysql
...
git submodule add https://github.com/gdsotirov/php.SlackBuild php
